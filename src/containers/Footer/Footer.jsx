      ...
      <div className="footer container py-3">
        ...
        <div className="info-rows">
          <div className="info">
            ...
            <div className="with-icon"><Icon src={Home} />{formatMessage(messages['DIGITAL LEARNING CENTER - HUTECH'])}</div>
            <div className="with-icon"><Icon src={LocationOn} />{formatMessage(messages['475A Dien Bien Phu, Ward 25, Binh Thanh District, Ho Chi Minh City'])}</div>
          ...
          <div className="connect">
            <div className="title">{formatMessage(messages.Connect)}</div>
          ...
          <div className="download">
            <div className="title">{formatMessage(messages['Download App'])}</div>
        ...
        <div className="text-right pt-3 pl-3 pr-3">© 2024 HUTECH. All rights reserved.</div>
      </div>
    </div>
  );
};
